            ...
            <div className="lg:w-3/5">
              ...
              <div className="flex flex-col gap-3 items-start max-w-md">
                {badgePhrases.map((phrase, index) => (
                  <div
                    key={index}
                    className="bg-gray-700/20 backdrop-blur-sm border border-gray-600/20 rounded-md px-4 py-2 text-white/80 text-sm hover:bg-gray-600/30 transition-all duration-200 hover:scale-105"
                  >
                    {phrase}
                  </div>
                ))}
