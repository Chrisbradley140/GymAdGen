...
export const generateCampaignPDF = async (campaign: CampaignWithContent) => {
  ...
  // Helper function to add logo image to bottom right
    ...
    try {
      ...
      return new Promise((resolve) => {
        logoImg.onload = () => {
          ...
          // Position logo at bottom right: x = pageWidth - margin - logoWidth, y = pageHeight - margin
          pdf.addImage(logoData, 'PNG', pageWidth - margin - 15, pageHeight - margin - 10, 12, 12);
          resolve(true);
        };
