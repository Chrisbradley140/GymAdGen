...
SELECT DISTINCT 
  user_id,
  'Legacy Campaign - ' || TO_CHAR(DATE_TRUNC('day', created_at), 'Mon DD, YYYY') as name,
  'Auto-created campaign for existing content from ' || TO_CHAR(created_at, 'FMMM/DD/YYYY') as description,
