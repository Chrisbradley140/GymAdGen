...
-- Make canonical_name NOT NULL and UNIQUE
ALTER TABLE campaign_templates ALTER COLUMN canonical_name SET NOT NULL;
ALTER TABLE campaign_templates ADD CONSTRAINT unique_canonical_name UNIQUE (canonical_name);
